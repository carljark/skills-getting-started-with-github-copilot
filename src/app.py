...
activities = {
    ...
    "Basketball Club": {
        "description": "Skills practice, pick-up games, and intramural competition",
    ...
    "Debate Team": {
        "description": "Prepare for tournaments and practice public speaking and argumentation",
        "schedule": "Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 18,
        "participants": ["oliver@mergington.edu", "amelia@mergington.edu"]
    },
    "Math Club": {
        "description": "Problem solving, math contests, and collaborative puzzles",
